...
aa = inputdlg({'Scatterplot, eg: 1 = yes, 0 = no','M/L Bar Plots','Downsampled Scatterplots', ...
    'Histograms', 'Density Heatmaps'}, ['Select Plotting Types - 1 = plot, ...' ...
    '0 = no plot']);
